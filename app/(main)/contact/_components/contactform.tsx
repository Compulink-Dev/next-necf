                    ...
                    <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3">
                        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-1">
                            ...
                            <div>
                                ...
                                <p className="mt-2 text-sm text-green-500 dark:text-green-400">34 Elizabeth Windsor Road, Marlborough</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2 text-sm text-green-500 dark:text-green-400">+263 242-701094 / +263 780 258 751 / +263 773 851 644 </p>
                            </div>
                        </div>
