...
//@ts-ignore
function ChairForm({ chair }) {

    const router = useRouter()
    const [loading, setLoading] = useState(false)
    const [imageUrl, setImageUrl] = useState(chair.image)
    ...
    async function onSubmit(data: any) {
        ...
        try {
            const chairData = { ...data, image: imageUrl }
        ...
        <div className=''>
            <form
                ...
                <div className="mb-6">
                    ...
                    {
                        errors.position && <p className="text-red-600 text-sm">
                            Oops!
