...
//@ts-ignore
function EditTaskForce({ program }) {
    ...
    async function onSubmit(data: any) {
        ...
        try {
            ...
            const response = await fetch(`/api/taskforce/${program._id}`, {
                method: "PUT",
        ...
        <div className=''>
            <form
                ...
                <div className="mb-6">
                    ...
                    {
                        errors.description && <p className="text-red-600 text-sm">
                            Oops!
