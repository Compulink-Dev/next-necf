  ...
  return (
    <div className="">
      <form onSubmit={handleSubmit(onSubmit)} action="" className="">
        ...
        <div className="mb-6">
          <Label className="text-slate-600">1: Description</Label>
          <Textarea
          ...
          {errors.description && (
            <p className="text-red-600 text-sm">
              Oops!
              <span className=""> description already taken</span>
            </p>
          )}
        </div>
        <div className="mb-6">
          <Label className="text-slate-600">2: Description</Label>
          <Textarea
            defaultValue={service.description2}
          ...
          {errors.description && (
            <p className="text-red-600 text-sm">
              Oops!
              <span className=""> description2 already taken</span>
            </p>
          )}
        </div>
        <div className="mb-6">
          <Label className="text-slate-600">3: Description</Label>
          <Textarea
            defaultValue={service.description3}
          ...
          {errors.description && (
            <p className="text-red-600 text-sm">
              Oops!
              <span className=""> description3 already taken</span>
            </p>
          )}
        </div>
