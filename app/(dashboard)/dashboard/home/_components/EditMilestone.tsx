...
//@ts-ignore
function EditMilestone({ section }) {
  ...
  async function handleDelete() {
    try {
      ...
      const res = await fetch(`/api/milestone/${section._id}`, {
        method: 'DELETE'
      })
  ...
  async function onSubmit(data: any) {
    ...
    try {
      ...
      const response = await fetch(`/api/milestone/${section._id}`, {
        method: "PUT",
      ...
      <form onSubmit={handleSubmit(onSubmit)} action="" className="">
        ...
        <div className="mb-6">
          ...
          {errors.subtitle && (
            <p className="text-red-600 text-sm">
              Oops!
              <span className=""> subtitle already taken</span>
            </p>
          )}
        </div>
        <div className="mb-6">
          <Label className="text-slate-600">Number</Label>
          <Textarea
          ...
          {errors.number && (
            <p className="text-red-600 text-sm">
              Oops!
              <span className=""> number already taken</span>
            </p>
          )}
        </div>
        <div className="mb-6">
